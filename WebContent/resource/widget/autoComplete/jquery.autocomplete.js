...
UAP.View = new Object();
// 初始化UdatePicker
UAP.View.AutoComplete = (function($) {
  ...
  Autocomplete.prototype = {
    ...
    suggest: function() {
      ...
      for (i = 0; i < len; i++) {
        ...
        /* 当无该城市时，字体加红 */
		if(undefined==this.data[i]){
        	div = $((me.selectedIndex === i ? '<div class="selected"' : '<div') + ' title="' + s + '"><span class="onfind">' + f(s, this.data[i], v) + '</span></div>');
		}else{
    ...
    select: function(i) {
      ...
      if(undefined==this.data[i]){return;}	//当选择项没有值时，不处理select事件。
      if (selectedValue) {
