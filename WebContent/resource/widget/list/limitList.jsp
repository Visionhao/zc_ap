...
<html>
    ...
    <body>
        ...
        <form name="tableId" action="${pageContext.request.contextPath}/view/widget/listItems-limitList.action" >
            <br><jmesa:tableModel
       ...
       <script type="text/javascript">
            function onInvokeAction(id) { 
                ...
                location.href = '${pageContext.request.contextPath}/view/widget/listItems-limitList.action?' + parameterString;
