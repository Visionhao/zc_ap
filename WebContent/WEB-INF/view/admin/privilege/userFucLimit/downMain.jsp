...
<div class="tab-wrap">
				<div class="dx_center">
					<ul class="tab2-nav">
						...
						<li><a href="###" class="selected">角色信息</a></li>
						<li><a href="###" class="">已授权功能</a></li>
						</c:if>
				...
				<div id="tab2-content">
					...
					<div id="downEditDiv" class="list" style="display: block;">
						<iframe id="downEditFrame" name="downEditFrame"
							src="<%=request.getContextPath()%>/view/admin/privilege/userFucLimit/Down1-main.action?QA_PARENT_ROW_KEY=<%= request.getAttribute("QA_PARENT_ROW_KEY")  %>"
							width='100%' height='400' frameborder="0"></iframe>
					</div>
					<div id="downListDiv" class="list none" style="display: none;">
						<div class="code-wrap">
							<iframe id="mainFrame" name="mainFrame"
								src="<%=request.getContextPath()%>/view/admin/privilege/userFucLimit/Down2-main.action?QA_PARENT_ROW_KEY=<%= request.getAttribute("QA_PARENT_ROW_KEY")  %>"
								width='100%' height='400' frameborder="0"></iframe>
						</div>
					</div>
