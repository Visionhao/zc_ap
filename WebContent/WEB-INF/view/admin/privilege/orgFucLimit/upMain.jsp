...
<body>
	<div class="dx_center">
		<ul class="tab2-nav">
			<li><a href="###" class="selected">机构授权</a></li>
	...
	<iframe id="upMainFrame" name="upMainFrame"
		src="<%=request.getContextPath()%>/view/admin/privilege/orgFucLimit/Up-main.action?orgAccountId=<%=request.getParameter("orgAccountId") %>"
