...
function onCheckNode(){
	...
	var treeIds = "<%=request.getAttribute("id") %>";
	var str= new Array(); 
	str = treeIds.split(",");
...
<body>
	<form id="editForm" name="editForm" action="<%=request.getContextPath()%>/view/admin/privilege/role/Down1-editFus.action">
	<input type="hidden"  id="ids" name="ids" />
	<input type="hidden"  id="ROLE_ID" name="ROLE_ID"  value="<%=request.getAttribute("QA_PARENT_ROW_KEY") %>"/>
	<center>
