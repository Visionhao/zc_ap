...
<script type="text/javascript">
	...
	function ref(){
		var url="${pageContext.request.contextPath}/view/admin/privilege/role/Down2-main.action?QA_PARENT_ROW_KEY=<%= request.getAttribute("QA_PARENT_ROW_KEY")  %>";
		window.location.href=url;
	}
</script>
<body >
<form name="down1ListTemplateForm" action="<%=request.getContextPath()%>/view/admin/privilege/role/Down2-list.action?QA_PARENT_ROW_KEY=<%=request.getAttribute("QA_PARENT_ROW_KEY") %>" method="post" target="down1MainFrame">
...
<table class="dataTable">
	<tr valign="top" >
		<td valign="top" >
			...
			<tr>
				<td valign="top"><iframe id="down1MainFrame" name="down1MainFrame"
					src="<%=request.getContextPath()%>/view/admin/privilege/role/Down2-list.action?QA_PARENT_ROW_KEY=<%=request.getAttribute("QA_PARENT_ROW_KEY") %>"
		...
		<div id="div1" class="div1">
			...
			<hr/>
		<form id="searchForm" name="searchForm" action="<%=request.getContextPath()%>/view/admin/privilege/role/Down2-list.action?QA_PARENT_ROW_KEY=<%=request.getAttribute("QA_PARENT_ROW_KEY") %>" method="post" target="down1MainFrame">
			<div class="content">
