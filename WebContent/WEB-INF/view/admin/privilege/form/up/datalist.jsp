...
<title>Insert title here</title>
  <script type="text/javascript">
	  function onInvokeAction(id) { 
	      ...
	      location.href = "${pageContext.request.contextPath}/view/admin/privilege/form/Up-alertSelect.action?QT_fusId=<%=request.getAttribute("id") %>&" + parameterString;
	  }
...
<body >
<form name="queryListTemplateForm" action="${pageContext.request.contextPath}/view/admin/privilege/form/Up-alertSelect.action" method="post">
		...
		<table id="searchArea" width="998" >
			<tr>
				...
				<div class="search-condition clearfix">
			      	...
			      	<div id="con1"><div class="field">资源编号</div><input name="QT_fusId" class="txt-input" type="text" value="${id }" id="QT_fusId"/></div>
			        </div>
