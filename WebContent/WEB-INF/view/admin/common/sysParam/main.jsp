...
<script type="text/javascript">
			function del(ids){
				$.ajax({  
		            url:'${pageContext.request.contextPath}/view/admin/common/sysParam/Do-delete.action',//先走校验的action   
		            type:"POST",          
		            data:"id="+ids,       
		            dataType:'text',  
			...
			function getIfrmaeCheckValue(objThis,iframeName,checkName,opt){
				var skip = 0;
				var modifyUrl = "${pageContext.request.contextPath}/view/admin/common/sysParam/Do-editPage.action?id=";
				var ids = "";
				 ...
				 if(opt=='edit'){
					 openwindow(comp,'修改系统参数',600,550);
				 }
				 if(opt=='show'){
					 var url = "${pageContext.request.contextPath}/view/admin/common/sysParam/Do-show.action?id="+ ids;
	            	 openwindow(url,'查看系统参数',600,550); 
				 }
			}
			$(function() {	
				$("#add-info").click(
						function() {
							openwindow('${pageContext.request.contextPath}/view/admin/common/sysParam/Do-addPage.action','新增系统参数',600,550); 
						});
			});
			function refresh(){
				var url = "${pageContext.request.contextPath}/view/admin/common/sysParam/Do-main.action";
				window.location.href=url;
			}
</script>
</head>
<body id="main_body">
<form name="SysParamForm" action="<%=request.getContextPath()%>/view/admin/common/sysParam/Do-list.action" method="post" target="mainFrame">
		...
		<table id="searchArea" width="100%" >		
			<tr>
				...
				<div class="search-condition clearfix">
			      	...
			      	<div id="con1"><div class="field">参数名</div><input name="QT_paramName" class="txt-input" type="text" id="QT_paramName" style="width:180px" /></div>
			      	<div id="con2"><div class="field">类别</div>
			      		<select id="QT_paramType" name="QT_paramType" >
			      	...
			      	<div id="con3"><div class="field">应用系统</div><input type="text" class="txt-input" id="QT_ofSys" name="QT_ofSys" style="width:180px" /></div>
			    	<div id="condition"  onmouseout="javascript:out()" onmouseover="javascript:over()" class="tout-chose" style="display:none;">
			      		<table border="0" class="other-chose">
			      			<tr>
			      			<td><input type="checkbox" checked id="chk1" onClick="javascript:checkCondition(this)"/><label for="chk1">参数名</label></td>
			      			</tr>
			      			<tr>
			      				<td><input type="checkbox" checked id="chk2" onClick="javascript:checkCondition(this)" /><label for="chk2">类别</label></td>
		      				</tr>
		      				<tr>
			      				<td><input type="checkbox" checked id="chk3"  onClick="javascript:checkCondition(this)" /><label for="chk3">应用系统</label></td>
		      				</tr>
			      		</table>
			      </div>
			...
			<tr>
				<td valign="top"><iframe id="mainFrame" name="mainFrame"
					src="<%=request.getContextPath()%>/view/admin/common/sysParam/Do-list.action?ajax=true"
