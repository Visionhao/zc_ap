...
<body>
	<div class="dx_center">
		<ul class="tab2-nav">
			<li><a href="###" class="selected">认证信息</a></li>
			<li><a href="###" class=""></a></li>		
		</ul>
		<div style="float:right; height: 30px;"><a id="up"  href="javascript:footShow()" title="向上" class="one-iocn">&nbsp;</a>
			&nbsp;&nbsp;&nbsp;<a id="mid"  href="javascript:midShow()" title="居中" class="three-iocn">&nbsp;</a>
			&nbsp;&nbsp;&nbsp;<a id="down"  href="javascript:topShow()" title="向下" class="two-iocn">&nbsp;</a></div>
	</div>
	<iframe id="upMainFrame" name="upMainFrame"
		src="<%=request.getContextPath()%>/view/admin/auth/cerRec/Up-main.action"
