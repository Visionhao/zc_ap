...
<html>
    ...
    <script type="text/javascript">
            function onInvokeAction(id) { 
                 ...
                 location.href = "${pageContext.request.contextPath}/view/rap/team/Complaintsback/ComplaintsBackAction-contentList.action?QT_mobile=<%=request.getAttribute("QT_mobile") %>&QT_port=<%=request.getAttribute("QT_port") %>&QT_content=<%=request.getAttribute("QT_content") %>&QD_month=<%=request.getAttribute("QD_month") %>&" + parameterString;
             }
            function onInvokeExportAction(id) {
                var parameterString = $.jmesa.createParameterStringForLimit(id);
                location.href = '${pageContext.request.contextPath}/view/rap/team/Complaintsback/ComplaintsBackAction-contentMain.action?' + parameterString;
            }
	 </script>
    </head>
    <body>
